...
class TweetBlender extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($post == null || ($post->ID != $archive_post_id && $archive_page_url != "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'])) {
			...
			echo('<div class="twitter-title"><a href="http://www.twitter.com/thecalmzone">@thecalmzone</a></div>');
			echo('<div class="follow-us"><a href="http://www.twitter.com/thecalmzone">Follow us</a></div>');
			...
			if(!isset($tb_o['archive_is_disabled'])) {
