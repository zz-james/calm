...
// 			}
			...
			switch($type) {
				...
				case "dropdown":
					...
					$obj_label = '<label for="'.$fields_name_prefix.$field_id.'">'.$description.'</label>';
				...
				case "checkbox":
					$obj_label = '<label class="cimy_uef_label_checkbox" for="'.$fields_name_prefix.$field_id.'">'.$label.'</label>';
					$obj_name = ' name="'.$input_name.'"';
					$obj_type = ' type="'.$type.'"';
					$obj_value = ' value="1"';
					$obj_value2 = "";
				...
				case "radio":
					$obj_label = '<label class="cimy_uef_label_radio" for="'.$fields_name_prefix.$field_id.'"> '.$label.'</label>';
					$obj_name = ' name="'.$input_name.'"';
					$obj_type = ' type="'.$type.'"';
			...
			if (($description != "") && ($type != "picture") && ($type != "picture-url")&& ($type != "dropdown")) {
